...
namespace GE::Scene {
    ...
    private:
        ...
        void handleMaterial(const std::string& id, const std::map<std::string, std::string>& properties, AssetManager* am, const std::vector<std::unique_ptr<Pipeline>>& pipelines);
