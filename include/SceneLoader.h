...
namespace GE::Scene {
    ...
    public:
        ...
        void load(const std::string& path,
            ...
            const std::vector<std::unique_ptr<GE::Graphics::Pipeline>>& pipelines,
    ...
    private:
        ...
        void handleMaterial(const std::string& id, const std::map<std::string, std::string>& properties, AssetManager* am, const std::vector<std::unique_ptr<GE::Graphics::Pipeline>>& pipelines);
