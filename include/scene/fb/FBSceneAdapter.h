...
namespace GE::Scene::FB {
    ...
    private:
        ...
        void adaptShape (const Simulation::Object* obj, GE::ECS::EntityID id, const glm::vec3& color, bool isContainer, FBSceneContext& ctx) const;
        void adaptBehaviour (const Simulation::Object* obj, GE::ECS::EntityID id, FBSceneContext& ctx) const;
        ...
        glm::vec3 resolveColor(const Simulation::Object* obj, const FBSceneContext& ctx) const;
    };
