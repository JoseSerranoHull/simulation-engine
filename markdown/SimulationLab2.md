...
![See attach SimulationLab2_Image1.png. The program is running on a window with the IMGUI top menu open that reads "Scenario/Clear Color Scenario"](../markdown-resources/Simulation-Lab/2/SimulationLab2_Image1.png)
...
![See attach SimulationLab2_Image2.png. The program is running on a window with the IMGUI top menu open that reads "Colour" that opened a Color picker IMGUI menu](../markdown-resources/Simulation-Lab/2/SimulationLab2_Image2.png)
...
- [See attach plane.sjg](../markdown-resources/Simulation-Lab/2/plane.sjg)
- [See attach sphere.sjg](../markdown-resources/Simulation-Lab/2/sphere.sjg)
...
![See attach SimulationLab2_Image3.png. A sphere with a checkboard material that can be changed via IMGUI top menu](../markdown-resources/Simulation-Lab/2/SimulationLab2_Image3.png)

And the plane model.

![See attach SimulationLab2_Image4.png. A plane with a checkboard material that can be changed via IMGUI top menu](../markdown-resources/Simulation-Lab/2/SimulationLab2_Image4.png)
...
![See attach SimulationLab2_Image5.png. Two spheres on top of a plane](../markdown-resources/Simulation-Lab/2/SimulationLab2_Image5.png)
...
![See attach SimulationLab2_Image6.png. Two spheres on top of a plane with the IMGUI top menu open that reads "Simulation" that opened a dropdown menu with a button that reads "Start" and a timestep input](../markdown-resources/Simulation-Lab/2/SimulationLab2_Image6.png)
